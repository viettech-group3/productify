...
const Div1 = () => {
    return (
        <div className={styles.total}>
            ...
            <p className={`${styles.paragraph} text-center`}>At Productify, our mission is to empower individuals and teams to enhance their productivity and achieve their goals efficiently. We believe that by providing a comprehensive and intuitive task management solution, we can help users stay organized, focused, and in control of their busy lives.</p>
            <div className="d-flex justify-content-evenly">
                ...
                <MissionCard 
                    ...
                    description=" With Productify, users can easily create, organize, control the schedule and track their tasks, ensuring nothing falls through the cracks"/>
                <MissionCard 
                    icon={faCalendar}
